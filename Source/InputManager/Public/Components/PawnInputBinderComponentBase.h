...
#include "PawnInputBinderComponentBase.generated.h"
...
class INPUTMANAGER_API UPawnInputBinderComponentBase : public UActorComponent
{
    GENERATED_BODY()
